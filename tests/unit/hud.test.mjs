// Unit: the wind-compass bearing helper (#50). The dial is ship-relative (bow up), so
// the arrow's angle is the wind bearing RELATIVE to heading, normalised to (-180, 180]
// so it stays bounded — and therefore centred — however far `heading` accumulates.
import test from 'node:test';
import assert from 'node:assert/strict';
import { windArrowDeg } from '../../src/hud.js';
...
test('does not drift as heading accumulates: full turns are equivalent', () => {
