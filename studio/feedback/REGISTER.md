...
| 2026-07-01-battle-not-fun-readability-isolation-diegetic | feedback | triaging | Marquee battle (#135) not fun: occluding popup, unclear target, rescue interferes, no visible cannonballs/angles, wants diegetic hover-interaction. GD+TL triage → `docs/briefs/2026-07-01-battle-fun-fixes.md` + slice issues | — (triage → issues) |
